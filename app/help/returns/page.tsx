        ...
        <div>
          ...
          <section style={{ marginBottom: "2rem" }}>
            ...
            <p style={{ color: "var(--mid)", marginBottom: "0.5rem" }}>
              Items can be returned within 7 days of delivery if:
            </p>
            <ul
              style={{
                listStyle: "disc",
          ...
          >
            <strong>Note:</strong> For quality issues, we cover return shipping.
            For size/fit changes, customer bears shipping cost.
          </div>
        </div>
      </main>
      <Footer />
