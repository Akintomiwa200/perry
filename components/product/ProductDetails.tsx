...
import { ShoppingCart, Heart, Share2, Package, Shield, RotateCcw } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
      ...
      <div className="flex flex-col gap-3">
        <div
          ...
          style={{ aspectRatio: '3/4', borderRadius: 'var(--radius-lg)', background: 'var(--color-secondary)' }}
        >
      ...
      <div className="flex flex-col gap-5">
        <div>
          <p className="text-sm font-medium uppercase tracking-wider mb-2" style={{ color: 'var(--color-primary)' }}>
            {product.category}
          </p>
          <h1 className="text-3xl font-bold mb-3" style={{ color: 'var(--color-text)' }}>{product.name}</h1>
          ...
          <div className="flex items-baseline gap-3">
            <span className="text-3xl font-bold" style={{ color: product.isSale ? 'var(--color-danger)' : 'var(--color-text)' }}>
        ...
        <div className="flex items-center gap-2">
          <span
            ...
            style={{ background: product.stock > 0 ? 'var(--color-success)' : 'var(--color-danger)' }}
          />
          <span className="text-sm font-medium" style={{ color: product.stock > 0 ? 'var(--color-success)' : 'var(--color-danger)' }}>
        ...
        {product.stock > 0 && (
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span
                  ...
                  style={{ borderLeft: '1px solid var(--color-border)', borderRight: '1px solid var(--color-border)', lineHeight: '40px' }}
                >
                  {qty}
                </span>
                <button
            ...
            <div className="flex gap-3">
              ...
              <button className="btn btn-outline btn-icon btn-lg" aria-label="Add to wishlist">
                <Heart size={18} />
              </button>
              <button className="btn btn-ghost btn-icon btn-lg" aria-label="Share">
                <Share2 size={18} />
              </button>
            </div>
          </div>
        ...
        >
          {[
            ...
            <div key={label} className="flex items-center gap-2 text-xs font-medium" style={{ color: 'var(--color-text)' }}>
