...
export default function About() {
  return (
    <div id="about" style={{ background: 'var(--deep)', display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 400 }}>
      <div style={{ padding: '5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 300, color: 'var(--cream)', lineHeight: 1.1, marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '3rem', marginTop: '1rem' }}>
          {[['3K+', 'Happy Customers'], ['500+', 'Products'], ['4★', 'Avg. Rating']].map(([num, label]) => (
            <div key={label}>
              <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2.8rem', fontWeight: 300, color: 'var(--gold)', lineHeight: 1 }}>{num}</div>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(135deg, var(--mid), var(--terracotta))' }}>
        <div style={{
        ...
        <div style={{
          ...
          fontSize: '3.2rem', fontWeight: 300, fontStyle: 'italic',
        ...
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', textAlign: 'center', width: '80%' }}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.5rem', fontStyle: 'italic', fontWeight: 300, color: 'var(--cream)', lineHeight: 1.5 }}>
            &ldquo;Every woman deserves to feel luxurious — without compromise.&rdquo;
          </p>
